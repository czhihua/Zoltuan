...
function imgVer(Config) {
    ...
    var left_Num = -X + 10;
    // 图形滑块验证码 DOM 生成
    var html = '<div style="position:relative;padding-bottom: 28px; margin-left:8px;margin-top:8px;border:1px solid #ccc;">';
    ...
    html += '</div>';
    html += '<br>';
    html += '<div style="position:relative;width:' + w + 'px;margin:auto;bottom:20px;">';
